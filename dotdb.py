...
<div class="container mt-4">
    <h1 class="text-center mb-4">Panel Manajemen API & Link</h1>

    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Tambahkan API</h5>
                    <form action="/add-api" method="post">
                        ...
                        <button class="btn btn-primary w-100" type="submit">Tambah API</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Tambahkan Link</h5>
                    <form action="/add-link" method="post">
                        ...
                        <button class="btn btn-success w-100" type="submit">Tambah Link</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Bagi Link ke API</h5>
                    <form action="/split-links" method="post">
                        <button class="btn btn-warning w-100" type="submit">Bagi Link</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Update Waktu</h5>
                    <form action="/update-waktu" method="post">
                        ...
                        <button class="btn btn-info w-100" type="submit">Update Waktu</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <h5 class="card-title">Daftar Link</h5>
            <ul class="list-group">
